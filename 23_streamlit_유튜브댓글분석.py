...
# youtube_link = "https://www.youtube.com/watch?v=95ULYjyiFLQ"
# max_num = 50
...
if submit_button:
    ...
    fig2 = alt.Chart(df).mark_circle().encode(x="score",
                                       y="like",
                                       size=alt.Size("reply", scale=alt.Scale(domain=[1, df["reply"].max()])),
                                       color="reply",
                                       tooltip=["score", "like", "reply"])
